...
_dBfile_matisse = '/Users/asoulain/Documents/These/DRS_MATISSE/DATA/data_matisse.dpy'
    
"""
Display MATISSE data
--------------------
    
python display_mat.py arg[0] arg[1]

arg[0] : name file
arg[1] : If low resolution data, add -l (empty if not)

All data are stored as python format in the _dBfile_matisse after the first opening, 
and is directly open after if the file is already in the database.

Add an alias to your path to open files anywhere in your computer : 
    alias display_mat='python /Users/asoulain/Documents/THESE/DRS_MATISSE/Python/display_mat.py' 
...
dis = True
try:
    name_file = sys.argv[1] #Comment if you want to use the name_file in the script
    ...
    print "(If low resolultion add -l as argument)"
    dis = False
