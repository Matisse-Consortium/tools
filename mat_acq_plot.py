...
def mat_acq_plot(filename):
    ...
    #naomi=hdu[0].header['HIERARCH ESO ISS AT4 NAOMI RTCMODE']
    a=1
    b=1
    ...
    for i in range(len(csky)-1):
        ...
        axes.add_artist(patches.Ellipse((m9x,m9y), 4*a, 1*b , 0,edgecolor = 'orange', fill=False, zorder = 2))
        ...
        axes.add_artist(patches.Ellipse((m10x,m10y), 4*a, 1*b , 0,edgecolor = 'orange', fill=False, zorder = 2))
        ...
        axes.add_artist(patches.Ellipse((m12x,m12y), 4*a, 1*b , 0,edgecolor = 'orange', fill=False, zorder = 2))
        ...
        axes.add_artist(patches.Ellipse((m13x,m13y), 4*a, 1*b , 0,edgecolor = 'orange', fill=False, zorder = 2))
