...
filename=dir+"CORRFLUX_CAL_MATISSE_GEN_LAMP_L108_0001.fits.gz"
...
#---------------------------------------------------------------------------------
imdet        = hdulist['OBJ_CORR_FLUX']   # The second table is usually the imaging_detector table listing the detector regions recroded in the file. 
...
print nrow
corrReal     = imdet.data['CORRFLUXREAL1']
corrImag     = imdet.data['CORRFLUXIMAG1']


plt.imshow(corrReal[5,:,:])